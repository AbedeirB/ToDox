                      ...
                      children: [
                        ...controller.tasks
                            .map((element) => LongPressDraggable(
                                  ...
                                  onDragEnd: (_) => controller.deleting(false),
                                  feedback: Opacity(
                                      opacity: 0.5,
            ...
            () => FloatingActionButton(
              onPressed: () {
                if (controller.tasks.isNotEmpty) {
                  ...
                  EasyLoading.showError('Add some tasks frist');
                }
              },
              backgroundColor:
